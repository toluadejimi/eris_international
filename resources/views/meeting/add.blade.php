                    ...
                    'id' => 'validation-form', "enctype" => "multipart/form-data"]) !!}
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-12 align-right">
                                    ...
                                    <button class="btn btn-primary" type="submit" value="Save" name="add_meeting" id="add-meeting">
                                        <i class="fa fa-save bigger-110"></i>
                                        Save
                                    </button>

                                    <button class="btn btn-success" type="submit" value="Save" name="add_meeting_another" id="add-meeting-another">
                                        <i class="fa fa-save bigger-110"></i>
